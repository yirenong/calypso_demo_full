...
import LandscapeManagement from './views/LandscapeManagement.vue'
...
const routes = [
    ...
    { path: '/tenant-management', name: 'TenantManagement', component: TenantManagement, meta: { requiresAuth: true } },
    { path: '/landscape-management', name: 'LandscapeManagement', component: LandscapeManagement, meta: { requiresAuth: true } },
    // catch-all
